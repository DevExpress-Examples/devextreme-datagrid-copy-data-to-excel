...
describe('install', () => {
    ...
    it('should add devextreme dependency (default)', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should add devextreme dependency (custom)', () => __awaiter(this, void 0, void 0, function* () {
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
    ...
    it('should add devextreme cli devDependency', () => __awaiter(this, void 0, void 0, function* () {
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
        const tree = yield runner.runSchematicAsync('install', { dxversion: '18.2.5' }, appTree).toPromise();
        const packageConfig = JSON.parse(tree.readContent('package.json'));
        expect(packageConfig.devDependencies['devextreme-cli']).toBeDefined();
    }));
    it('should add devextreme styles', () => __awaiter(this, void 0, void 0, function* () {
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
        const tree = yield runner.runSchematicAsync('install', {}, appTree).toPromise();
    ...
    it('should register jszip', () => __awaiter(this, void 0, void 0, function* () {
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
        const tree = yield runner.runSchematicAsync('install', {}, appTree).toPromise();
    ...
    it('should add devextreme styles to the specified project', () => __awaiter(this, void 0, void 0, function* () {
